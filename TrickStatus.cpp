...
void TrickStatus::Update(const TrickBasic_Memory&  trick_in_progress
                         ,bool hasCol
                         ,bool hasTrump)
{
    ...
    _myPosition = _infos.IntToPosTrick(trick_in_progress.NumberCardsPlayed()); //my position in the trick
